...
class Cloudflare_R2_service_Access:
    def __init__(self) -> None:
        ...
        R2_ACCESS_KEY_ID = service_account_info["access_key_id"]
        R2_SECRET_ACCESS_KEY = service_account_info["secret_access_key"]
        R2_ENDPOINT_URL = service_account_info["jurisdiction_specific_endpoints"]
